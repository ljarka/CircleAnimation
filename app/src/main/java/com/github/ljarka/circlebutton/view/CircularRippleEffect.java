...
public class CircularRippleEffect extends View {
    ...
    public CircularRippleEffect(Context context, AttributeSet attrs) {
        ...
        try {
            rippleSize = typedArray.getDimensionPixelSize(R.styleable.CircularRippleEffect_rippleSize, 100);
        } finally {
            typedArray.recycle();
        }
        init();
    ...
    private void init() {
        ...
        int dotColor = getColor(getContext(), R.color.ripple_effect_color_color);
